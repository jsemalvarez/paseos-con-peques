...
export const AboutAs = () => {
  return (
    <div  className='min-h-screen flex flex-col md:flex-row items-center justify-center gap-8 p-6 md:p-12'>
      ...
      <div class="w-full max-w-[600px] h-full md:w-1/2">
        <h2 class="text-3xl md:text-4xl font-bold text-pink-600 mb-4 tracking-wide flex flex-col justify-center items-center">
          ¿Quiénes somos?
        </h2>
        <div class="text-lg text-pink-200 leading-relaxed">
